...
type ColorName = Color;
type TailwindClass = string;
type ColorObject = Record<TailwindClass, boolean>;
type ColorsDictionary = Record<ColorName, ColorObject>;

export const COLORS: ColorsDictionary = {
  success: {
    'bg-success-700': true,
